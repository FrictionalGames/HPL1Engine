...
namespace hpl {
	...
	{
		iPhysicsBody *mpContactBody1 = (cPhysicsBodyNewton*) NewtonBodyGetUserData(NewtonJointGetBody0(contacts));
		iPhysicsBody *mpContactBody2 = (cPhysicsBodyNewton*) NewtonBodyGetUserData(NewtonJointGetBody1(contacts));
