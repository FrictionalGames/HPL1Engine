...
namespace Mapeditor
{
	...
	/// </summary>
	public class frmParticles : System.Windows.Forms.Form
	{
		private frmMain mMainForm;

		public ArrayList mlstParticles;
		...
		private void InitializeComponent()
		{
			...
			this.objTypeText.Text = "Particle type:";
			// 
			// frmParticles
			// 
			...
			this.Name = "frmParticles";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.Text = "Particle Toolbox";
			this.TopMost = true;
